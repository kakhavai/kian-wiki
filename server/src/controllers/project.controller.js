...
import { ProjectService, UserService } from 'server/src/services';
...
class ProjectController {
  static async create(req, res, next) {
    try {
      ...
      const newProject = await ProjectService.create(projectName, creation, creator);
  ...
  static async update(req, res, next) {
    try {
      ...
      const updatedProject = await ProjectService.update(projectName, creation, creator);
  ...
  static async partialUpdate(req, res, next) {
    try {
      ...
      const updatedProject = await ProjectService.partialUpdate(projectName, creation, creator);
